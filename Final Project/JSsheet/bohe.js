...
$(function () {
    // ===== List 생성하기 =====
    addItem('Bohemian Rhapsody', './musics/Bohe/Bohe.png', './musics/Bohe/Queen – Bohemian Rhapsody.mp3');
    addItem('We Will Rock You', './musics/Bohe/Bohe.png', './musics/Bohe/Queen - We Will Rock You.mp3');
    addItem('We Are The Champions', './musics/Bohe/Bohe.png', './musics/Bohe/Queen - We Are The Champions.mp3');
